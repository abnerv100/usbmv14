...
export default function Dashboard() {
  ...
  const { 
    ...
    roiData 
  } = dashboardData || { metrics: {} as DashboardMetrics, recentCampaigns: [], aiInsights: [], timeSeriesData: {labels:[], datasets:[]}, channelPerformanceData: {labels:[], datasets:[]}, roiData: {labels:[], datasets:[]} };
  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-5">
        ...
        <Card className="neu-card"><CardHeader className="flex flex-row items-center justify-between pb-2"><CardTitle className="text-sm font-medium text-glow-primary">ROI</CardTitle><TrendingUp className="h-4 w-4 text-muted-foreground" /></CardHeader><CardContent><div className="text-2xl font-bold">{metrics.avgROI?.toFixed(2)}x</div></CardContent></Card>
